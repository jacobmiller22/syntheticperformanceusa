...
const ROUTE_MAP: Record<string, string> = {
  ...
  "transmission-fluid": "https://www.amsoil.com/shop/by-product/transmission-fluid/",
  "filtration": "https://www.amsoil.com/shop/by-product/filters-and-by-pass-systems/",
  "filters": "https://www.amsoil.com/shop/by-product/filters-and-by-pass-systems/",
...
export default {
  async fetch(request: Request, env: Env, _ctx: ExecutionContext): Promise<Response> {
    ...
    if (url.pathname.startsWith("/go/") || url.pathname === "/go") {
        ...
        try {
          ...
          if (customTo.startsWith("/")) {
            ...
            if (!parsed.hostname.endsWith("amsoil.com")) {
              return new Response("Invalid redirect destination: must be amsoil.com", { status: 400 });
            }
            target = customTo;
          }
      ...
      return Response.redirect(buildReferralUrl("https://www.amsoil.com/", zoNumber), 307);
    }
